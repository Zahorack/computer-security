...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        ...
        java.net.URL helpURL = PasswordManager.class.getResource("/help/uvod.html");
        if (helpURL != null) {
            try {
    ...
    private void loadUlohy(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadUlohy
        java.net.URL helpURL = PasswordManager.class.getResource("/help/ulohy.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadSalt(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadSalt
        java.net.URL helpURL = PasswordManager.class.getResource("/help/salt.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadDelay(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadDelay
        java.net.URL helpURL = PasswordManager.class.getResource("/help/delay.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void loadHash(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loadHash
        java.net.URL helpURL = PasswordManager.class.getResource("/help/hash.html");
        if (helpURL != null) {
            try {
                jEditorPane1.setPage(helpURL);
            } catch (IOException e) {
    ...
    private void LogIn(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LogIn
        ...
        jPasswordField2.setText(null);
                ...
                MyResult result = Login.newSession(jTextField1.getText(), String.valueOf(jPasswordField2.getPassword()));
    ...
    public static void main(String args[]) {
        ...
        java.net.URL helpURL = PasswordManager.class.getResource(
                                        "pokus.html");
        if (helpURL != null) {
            try {
